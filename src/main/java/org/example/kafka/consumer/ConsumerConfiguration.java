...
public class ConsumerConfiguration {
    ...
    public ConsumerFactory<String, StringValue> consumerFactory(
        ...
        props.put(TYPE_MAPPINGS, "org.example.kafka.producer.StringValue:org.example.kafka.producer.StringValue");
    ...
    listenerContainerFactory(ConsumerFactory<String, StringValue> consumerFactory) {
        ...
        factory.getContainerProperties().setConsumerTaskExecutor(listenerTaskExecutor);
        return factory;
    }
